  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppTheme.border.withOpacity(0.35), // Gray-800
          ...
          if (widget.isCardio) ...[
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              filled: true,
                              fillColor: AppTheme.background.withOpacity(0.8),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: set.completed ? const Color(0xFF10B981) : AppTheme.borderLight,
                                  ),
                                  borderRadius: BorderRadius.circular(10),
                                ),
                                child: Icon(
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                side: BorderSide(color: AppTheme.borderLight.withOpacity(0.6)),
