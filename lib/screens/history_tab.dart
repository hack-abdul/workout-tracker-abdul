        ...
        children: [
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: isSelectedDay
                          ...
                          : hasWorkout
                              ? Colors.transparent
                              : AppTheme.borderLight.withOpacity(0.2),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppTheme.borderLight.withOpacity(0.2)),
        ...
        itemBuilder: (context, index) {
          ...
          return ChoiceChip(
            ...
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(12),
              side: BorderSide(
                color: isSelected ? const Color(0xFF2563EB) : AppTheme.borderLight.withOpacity(0.3),
                width: 1,
              ),
            ),
            showCheckmark: false,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                ...
                borderSide: BorderSide(color: AppTheme.borderLight.withOpacity(0.3)),
              ),
                                  ...
                                  if (isExpanded)
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border(
                                          top: BorderSide(color: AppTheme.borderLight.withOpacity(0.3)),
                                        ),
                                      ),
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
