...
class _NutritionTabState extends State<NutritionTab> {
  ...
  void _onPlanCreated(NutritionProfile profile, NutritionPlan plan) async {
...
class SetupView extends StatefulWidget {
  ...
  final void Function(NutritionProfile, NutritionPlan) onPlanCreated;
...
class _SetupViewState extends State<SetupView> {
  ...
  Future<void> _startPlan() async {
    ...
    widget.onPlanCreated(profile, plan);
  ...
  Widget _genderChip(String label, String value) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selected ? const Color(0xFF10B981).withOpacity(0.15) : const Color(0xFF030712),
          border: Border.all(color: selected ? const Color(0xFF10B981) : const Color(0xFF1F2937)),
  ...
  Widget _unitChip(String value) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 8),
        decoration: BoxDecoration(
          color: selected ? const Color(0xFF6366F1).withOpacity(0.15) : const Color(0xFF030712),
          border: Border.all(color: selected ? const Color(0xFF6366F1) : const Color(0xFF1F2937)),
          borderRadius: BorderRadius.circular(10),
        ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: selected ? const Color(0xFF10B981).withOpacity(0.4) : const Color(0xFF1F2937)),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('CUT', style: GoogleFonts.inter(fontSize: 10, color: const Color(0xFF10B981), fontWeight: FontWeight.w900)),
              Text('Your Progress', style: GoogleFonts.outfit(fontSize: 22, fontWeight: FontWeight.w900, color: Colors.white)),
            ]),
            Row(
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Text('Report', style: GoogleFonts.inter(color: Colors.grey, fontSize: 11, fontWeight: FontWeight.bold)),
                    ]),
                  ),
                ),
                const SizedBox(width: 8),
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      const Icon(Icons.edit_outlined, color: Colors.grey, size: 14),
                      const SizedBox(width: 4),
                      Text('Edit Plan', style: GoogleFonts.inter(color: Colors.grey, fontSize: 11, fontWeight: FontWeight.bold)),
                    ]),
                  ),
                ),
              ],
              ...
              if (today == null || _isEditingNutrition) ...[
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF1F2937).withOpacity(0.8),
                      padding: const EdgeInsets.symmetric(vertical: 13),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(14),
                        side: BorderSide(color: const Color(0xFF374151).withOpacity(0.5)),
                      ),
                    ),
                  ),
                ),
