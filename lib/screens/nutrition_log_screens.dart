            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isToday
                    ...
                    : const Color(0xFF374151).withOpacity(0.25),
                width: isToday ? 1.5 : 1,
              ),
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: isSelected ? const Color(0xFF6366F1) : const Color(0xFF374151)),
                            ),
                            child: Text(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [slab.gradeColor.withOpacity(0.15), const Color(0xFF111827)],
