...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String _friendlyAuthError(String code) {
    switch (code) {
      ...
      case 'unauthorized-domain':
        return 'This domain is not authorized in Firebase. Add "localhost" to authorized domains in the Firebase Console under Authentication → Settings.';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppTheme.background, // Zinc-950
      body: Center(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppTheme.surface.withOpacity(0.55), // Gray-900 with opacity
                  border: Border.all(color: AppTheme.borderLight.withOpacity(0.4)), // Gray-700
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: WidgetStateProperty.resolveWith((states) {
                            if (states.contains(WidgetState.disabled)) {
                              return AppTheme.border.withOpacity(0.5);
                            }
