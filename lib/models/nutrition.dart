...
class NutritionPlan {
  ...
  NutritionPlan({
    ...
    this.completionDate,
    this.actualEndWeightKg,
    this.overallGrade,
    this.overallAdherenceScore,
    this.loggedDaysCount,
    this.totalDeficitKcal,
  });
  ...
  Map<String, dynamic> toJson() => {
        ...
        if (actualEndWeightKg != null) 'actualEndWeightKg': actualEndWeightKg,
        if (overallGrade != null) 'overallGrade': overallGrade,
        if (overallAdherenceScore != null) 'overallAdherenceScore': overallAdherenceScore,
        if (loggedDaysCount != null) 'loggedDaysCount': loggedDaysCount,
        if (totalDeficitKcal != null) 'totalDeficitKcal': totalDeficitKcal,
      };

  factory NutritionPlan.fromJson(Map<String, dynamic> json, [String? docId]) => NutritionPlan(
        ...
        actualEndWeightKg: (json['actualEndWeightKg'] as num?)?.toDouble(),
        overallGrade: json['overallGrade'] as String?,
        overallAdherenceScore: (json['overallAdherenceScore'] as num?)?.toDouble(),
        loggedDaysCount: json['loggedDaysCount'] as int?,
        totalDeficitKcal: (json['totalDeficitKcal'] as num?)?.toDouble(),
      );
